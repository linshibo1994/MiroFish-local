...
**具体类型的设计原则**：
- 从文本中识别出高频出现或关键的角色类型
- 受害人、嫌疑人、被告人、当事人、主配角、亲属等核心人物类型即使不一定主动发声，也必须作为图谱实体类型保留
- 不论事件类型如何，必须包含至少 4 个事件角色实体类型（从 Victim、Suspect、Witness、FamilyMember、Police、LegalExpert 等中选取），确保事件中的核心人物和角色能被精确捕捉
- 每个具体类型应该有明确的边界，避免重叠
...
- FamilyMember: 家属/亲属，当事人(受害人/嫌疑人)的家庭成员
...
**必须遵守的规则**：
1. 不要固定为10个实体类型；请按文本真实主体需要输出，完整覆盖关键事件主体和可发声主体类型
2. 最后2个必须是兜底类型：Person（个人兜底）和 Organization（组织兜底）
3. 具体类型包含但不限于：政府/监管、单位、机构、企业/品牌、媒体、组织/协会、意见领袖/网红、社区、公众、主配角、网民/个人等
4. 受害人、被害人、嫌疑人、被告人、当事人、主角、配角、亲属等核心人物类型不能因为“不一定发声”而被省略
